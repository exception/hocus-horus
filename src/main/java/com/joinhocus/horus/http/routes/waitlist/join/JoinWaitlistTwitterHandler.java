package com.joinhocus.horus.http.routes.waitlist.join;
...
public class JoinWaitlistTwitterHandler implements DefinedTypesHandler<EmptyRequest> {

    private final String CALLBACK_URL = Environment.current().getUrl() + "/join";
